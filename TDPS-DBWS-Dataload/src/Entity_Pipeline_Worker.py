...
if entity_configs:
    if configured_entity_name not in entity_configs:
        ...
        raise KeyError(f"Entity '{configured_entity_name}' was not found in source config. Available entities: {available_entities}")
else:
    ...
    if configured_root_entity_name and configured_root_entity_name != configured_entity_name:
        raise KeyError(f"Entity '{configured_entity_name}' does not match root config entity '{configured_root_entity_name}'.")
